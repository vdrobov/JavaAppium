...
public class MainPageObject {
    ...
    public void assertElementHasText(String locator, String expected_value, String error_message, long timeoutInSeconds)
    {
        WebElement element = waitForElementPresent(locator, error_message, timeoutInSeconds);
    ...
    public String waitForElementAndGetAttribute(String locator, String attribute, String error_message, long timeoutInSaconds)
    {
        WebElement element = waitForElementPresent(locator, error_message, timeoutInSaconds);
